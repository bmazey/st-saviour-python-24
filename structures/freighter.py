...
class Freighter:
    ...
    def push(self, container: str) -> None:
        ...
        # use append the new container to the stack containers
    ...
    def pop(self) -> str:
        ...
        of an error
        """
        # if stack is empty, return empty string instead of error
        # use pop function to remove the last element of the stack
        if self.containers:
