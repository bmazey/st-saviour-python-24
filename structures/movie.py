...
class Movie:
    ...
    """
    def __init__(self):
        # Initializes an empty list to store patrons in the queue
        self.patrons = []

    def enqueue(self, patron: str) -> None:
        """adds a patron to the patrons list, returns None"""
        # Adds a patron to the end of the queue
    ...
    def dequeue(self) -> str:
        ...
        if len(self.patrons) == 0:
            return ''
        # Removes and returns the name of the first patron in line
        name = self.patrons[0]
        self.patrons.pop(0)
        return name
    ...
    def first(self) -> str:
        ...
        # Returns the name of the first patron without removing them from the queue
        return self.patrons[0]

    def last(self) -> str:
        """reads and returns the name of the last patron in line"""
        # Returns the name of the last patron without removing them from the queue
